...
SRC_DATASET_NAME: str = 'nontiled-prostate-1x512x512'
...
for i, row in df_test_data.iterrows():
    ...
    if os.path.exists(os.path.join(DEST_TRAIN_IMAGES_FOLDER_PATH, img_file_name)):
        ...
        set_err_imgs.add(image_id)

    if os.path.exists(os.path.join(DEST_TRAIN_MASKS_FOLDER_PATH, img_file_name)):
